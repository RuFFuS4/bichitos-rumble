...
> - **Lo que pasa por él:** cabezazo recibido y el retroceso del propio cabezazo, roce, golpe de dash (H1), reflejo y rebote de Steel Shell, las K radiales y de cono, el impacto de Shadow Step, la bola de nieve, Saw Shell, la embestida, Cone Pulse. **No pasan:** el golpe del All-in (echa fuera a quien pilla, decisión de Rafa del 2026-05-01), el tirón del Sinkhole (es una zona, no un golpe; tampoco la masa lo toca) ni el del Grip, que lo trae entero (Rafa, 2026-09-25: «entero»; antes recorría 0,4 del camino). El aturdido ×4 y el 0,4 se multiplican: ×1,6.
...
>   - Grip desde 8 u: lo traía 6,4 u, hasta 1,6 u de Trunk; con el 0,4, 2,56 u y se quedaba a 5,44 u, aturdido. Desde el 2026-09-25 vuelve a traerlo entero, hasta 1,6 u (Rafa: «entero»).
...
>   - Servidor, con el mismo choque: Sergei sale a 30,1 → 12,0 u/s, su retroceso 24,0 → 9,6 u/s, el Grip lo dejaba a 5,44 u (hasta el 2026-09-25; ahora a 1,6 u) y la Kurama que lo copia pasa a × 0,4 al acabar la carga (`.tmp/fase2/h3/server-kb.test.ts`).
...
> - ~~**Para Rafa:** el Grip a un Sergei en frenesí lo deja a medio camino.~~ Rafa, 2026-09-25: «entero». El Grip lo trae hasta la trompa como a cualquiera; el frenesí solo resiste los golpes.
...
> - **Apuntar mientras carga.** Sebastian sigue enraizado, y la regla de «el facing sigue a la velocidad» no giraba nada. Ahora, mientras carga, `Critter.update` no toca el facing y `advanceAllInCharge` lo gira hacia el stick a `FEEL.allIn.aimTurnDegPerSec` (180°/s desde el 2026-09-25: 90° en 0,5 s, media vuelta en 1 s; antes 360), por el lado corto. Sin stick mantiene la puntería. Confundido, el stick sale invertido, como todo lo demás.
> - **Por qué con tope de giro y no instantáneo:** la línea barre en vez de saltar, así que los demás la ven venir. Un giro instantáneo en el último paso dejaría la carga mínima sin tiempo de reacción. Con 180°/s, un toque con el stick girado 90° sale a los 0,5 s en la nueva dirección (a 360°/s salía a los 0,35 s).
...
>   - **2026-09-25, a 180°/s** (Rafa lo dejó a PERSONAJES). A un rival que corre, la puntería lo sigue igual: lo que cambia es el giro de sorpresa. A 360°/s, Sebastian cargando de espaldas se giraba 180° en 0,5 s, antes de que nadie leyera la línea (reacción ~0,25 s + ~0,5 s para salir del pasillo). Ahora tarda 1 s. Los bots no apuntan mientras cargan (disparan con el rival ya en la línea): en una tanda de 24 partidas, 360, 180 y 120°/s dan los mismos 62 All-in. Solo cambia el juego humano.
