# Build Log — Bichitos Rumble (pre-launch archive, 2026-04-08 → 2026-04-19)

> **Archived on 2026-04-22.** The live BUILD_LOG.md was getting close to
> 3000 lines; the entries from the first two weeks (prototype → roster →
> first public deploy → online 4P → gamepad → skeletal loader → /animations
> lab → arena shake) landed in this file so dispatch sessions don't have
> to scroll through pre-launch history before seeing what's current.
>
> The active log (2026-04-20 and onwards) lives in the root `BUILD_LOG.md`.
>
> Nothing here was removed — this is a move, not a trim.
