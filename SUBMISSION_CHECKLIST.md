...
- [ ] Skeletal animations populated for the roster — **6/9 completos** (Cheeto 8/8, Kermit 7/8 + Hypnosapo procedural, Kowalski 8/8, Trunk 8/8, Shelly 6/8 + Shell Charge/Shell Shield procedurales, Kurama 8/8 via Meshy). Pendientes: Sergei (solo idle), Sebastian, Sihans. User pipeline: Meshy AI + Tripo Animate → `scripts/import-critter.mjs`.
