...
- [ ] Skeletal animations populated for the roster — **7/9 completos** (Cheeto 8/8, Kermit 7/8 + Hypnosapo procedural, Kowalski 8/8, Trunk 8/8, Shelly 6/8 + Shell Charge/Shell Shield procedurales, Kurama 8/8 via Meshy, Sebastian 6/8 + Claw Rush/Crab Slash procedurales via Meshy). Pendientes: Sergei (solo idle), Sihans. User pipeline: Meshy AI + Tripo Animate → `scripts/import-critter.mjs`.
